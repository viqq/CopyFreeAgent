CREATE TABLE USER (
  ...
  ROLE VARCHAR(15) NOT NULL DEFAULT 'ROLE_MODERATOR',
  ...
  CHECK (ROLE = 'ROLE_MODERATOR' OR ROLE = 'ROLE_ADMIN'),
);
...
CREATE INDEX IN_SPORT ON USER (SPORT_ID, NAME);
CREATE INDEX IN_MESSAGE ON USER (MESSAGE_ID);

INSERT INTO USER (USER_ID, EMAIL, PASSWORD)
VALUES (1, 'Viqq@i.ua', 'qwerty123');
